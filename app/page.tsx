...
export default async function HomePage() {
  ...
  const heroText = getSetting('hero_text', 'Vi tilbyr steinprodukt av høgaste kvalitet, bobilparkering ved fjorden, og eit unikt lokale til dine selskap.');
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <Link href="/camping">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-2 cursor-pointer h-full flex flex-col group">
              ...
              <div className="p-6 flex-grow">
                ...
                <p className="text-gray-600 mb-4">
                  Opplev naturen ved fjorden. Bestill plass til bobil, campingvogn eller telt.
                </p>
                <div className="text-[var(--color-primary)] font-semibold flex items-center mt-auto">
                  Bestill no
                  <svg className="w-5 h-5 ml-2 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/arrangement">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-2 cursor-pointer h-full flex flex-col group">
              ...
              <div className="p-6 flex-grow">
                <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-[var(--color-primary)] transition-colors">Sjøbuo selskapslokale</h3>
                <p className="text-gray-600 mb-4">
                  Unikt lokale for bryllup, konfirmasjonar, firmafestar og andre spesielle anledningar.
                </p>
                <div className="text-[var(--color-primary)] font-semibold flex items-center mt-auto">
