              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 mb-3">
                    Besøk vår <Link href="/nettbutikk" className="text-[var(--color-primary)] hover:underline font-semibold">nettbutikk</Link> for å sjå produkt, prisar og legge inn bestilling. Vi leverer til heile regionen.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Kontakt oss for tilgjenge og prisar for arrangement i våre lokale.
                  </p>
                </div>
