        ...
        <div className="min-h-screen bg-gray-50">
          <div className="container mx-auto px-4 py-16">
            ...
            <div className="bg-white rounded-lg shadow-md p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">{t('emptyText')}</p>
              <Link
                href="/nettbutikk"
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <p className="text-[var(--color-primary)] font-bold">
                        {(item.price / 100).toFixed(0)} kr <span className="text-gray-500 text-sm">{t('inclVat')}</span>
                      </p>
                      <p className="text-gray-500 text-sm">
                        {t('subtotal')} <span className="font-bold text-gray-900">{((item.price * item.quantity) / 100).toFixed(0)} kr</span>
                      </p>
                    </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('summary')}</h2>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <p className="text-sm text-gray-600">{t('inclVat')}</p>
                </div>
      ...
      {isCheckoutOpen && items.length > 0 && (
        <CheckoutModal
          ...
          product={{
            id: 'cart',
            name: t('cartSummary', { count: items.length }),
            price: totalPrice,
          }}
          cartItems={items}
